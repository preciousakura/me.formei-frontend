...
import { DisciplineAdminParamList, DisciplineProp } from "../../../types/types";
...
export function DisciplineAdminDetails() {
  const { colors } = useThemeNative();
  const { theme } = useTheme();
  const { params } =
    useRoute<RouteProp<DisciplineAdminParamList, "DisciplineAdminDetails">>();
